<?php
// filepath: c:\xampp\htdocs\AppRegistroyControl\vigilantes.php

include 'conexion_be.php'; // Asegúrate de que este archivo contiene la conexión a la base de datos

// Consulta SQL para obtener los registros de la tabla vigilantes junto con el nombre, apellido y cédula del trabajador
...
<head>
    ...
    <link rel="stylesheet" href="Stilos/styles_vigilantes.css"> <!-- Opcional: agrega estilos -->
...
<body>
    ...
    <!-- Tabla para mostrar los vigilantes -->
    <h2>Lista de Vigilantes</h2>
    <a href="descargar.php?file=registros_vigilantes.pdf" class="download-button">Descargar</a>
