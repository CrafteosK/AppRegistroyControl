<?php
// filepath: c:\xampp\htdocs\AppRegistroyControl\obreros.php

include 'conexion_be.php'; // Asegúrate de que este archivo contiene la conexión a la base de datos

// Consulta SQL para obtener los registros de la tabla obreros junto con el nombre, apellido y cédula del trabajador
...
<head>
    ...
    <link rel="stylesheet" href="Stilos/styles_obreros.css"> <!-- Opcional: agrega estilos -->
...
<body>
    ...
    <h1>Gestión de Obreros</h1>

    <!-- Tabla para mostrar los obreros -->
    <h2>Lista de Obreros</h2>
    <a href="descargar.php?file=registros_obreros.pdf" class="download-button">Descargar</a>
